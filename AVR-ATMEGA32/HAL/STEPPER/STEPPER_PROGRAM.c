...
void STEPPER_Init()
{
	DIO_SetPinDirection(STEPPER_BLUE_PIN,OUTPUT);
	DIO_SetPinDirection(STEPPER_PINK_PIN,OUTPUT);
	DIO_SetPinDirection(STEPPER_YELLOW_PIN,OUTPUT);
	DIO_SetPinDirection(STEPPER_ORANGE_PIN,OUTPUT);
}
